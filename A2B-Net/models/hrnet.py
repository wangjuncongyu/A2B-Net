...
from tensorflow.keras.layers import (Activation, LayerNormalization, Conv2D,
                                     Layer, ZeroPadding2D, add, Input)
...
def basic_Block(input, out_filters, strides=(1, 1), with_conv_shortcut=False, name=""):
    ...
    if with_conv_shortcut:
        ...
        residual = LayerNormalization( name=name+'.downsample.1')(residual)
        x = add([x, residual])
    else:
        x = add([x, input])
...
def bottleneck_Block(input, out_filters, strides=(1, 1), with_conv_shortcut=False, name=""):
    ...
    x = LayerNormalization( name=name+'.bn3')(x)
...
def stem_net(input):
    ...
    x = Conv2D(64, 3, strides=(1, 1), padding='valid', use_bias=False, kernel_initializer='he_normal', name="conv1")(x)
    x = LayerNormalization( name="bn1")(x)
    x = Activation('relu')(x)
    ...
    x = LayerNormalization( name="bn2")(x)
    x = Activation('relu')(x)
...
def transition_layer1(x, out_filters_list=[32, 64]):
    ...
    x0 = LayerNormalization( name="transition1.0.1")(x0)
    ...
    x1 = LayerNormalization( name="transition1.1.0.1")(x1)
...
def make_stage2(x_list, out_filters_list=[32, 64]):
    ...
    x0_1 = LayerNormalization( name="stage2.0.fuse_layers.0.1.1")(x0_1)
    ...
    x1_0 = LayerNormalization( name="stage2.0.fuse_layers.1.0.0.1")(x1_0)
    x1_1 = x1
...
def transition_layer2(x, out_filters_list=[32, 64, 128]):
    ...
    x2 = LayerNormalization( name="transition2.2.0.1")(x2)
...
def make_stage3(x_list, num_modules, out_filters_list=[32, 64, 128]):
    for i in range(num_modules):
        ...
        x0_1 = LayerNormalization( name="stage3." + str(i) + ".fuse_layers.0.1.1")(x0_1)
        ...
        x0_2 = LayerNormalization( name="stage3." + str(i) + ".fuse_layers.0.2.1")(x0_2)
        ...
        x1_0 = LayerNormalization( name="stage3." + str(i) + ".fuse_layers.1.0.0.1")(x1_0)
        x1_1 = x1
        x1_2 = Conv2D(out_filters_list[1], 1, use_bias=False, kernel_initializer='he_normal', name="stage3." + str(i) + ".fuse_layers.1.2.0")(x2)
        x1_2 = LayerNormalization( name="stage3." + str(i) + ".fuse_layers.1.2.1")(x1_2)
        ...
        x2_0 = LayerNormalization( name="stage3." + str(i) + ".fuse_layers.2.0.0.1")(x2_0)
        ...
        x2_0 = LayerNormalization( name="stage3." + str(i) + ".fuse_layers.2.0.1.1")(x2_0)
        ...
        x2_1 = LayerNormalization( name="stage3." + str(i) + ".fuse_layers.2.1.0.1")(x2_1)
        x2_2 = x2
...
def transition_layer3(x, out_filters_list=[32, 64, 128, 256]):
    ...
    x3 = LayerNormalization( name="transition3.3.0.1")(x3)
...
def make_stage4(x_list, num_modules, out_filters_list=[32, 64, 128, 256]):
    for i in range(num_modules):
        ...
        x0_1 = LayerNormalization( name="stage4." + str(i) + ".fuse_layers.0.1.1")(x0_1)
        ...
        x0_2 = LayerNormalization( name="stage4." + str(i) + ".fuse_layers.0.2.1")(x0_2)
        ...
        x0_3 = LayerNormalization( name="stage4." + str(i) + ".fuse_layers.0.3.1")(x0_3)
        ...
        x1_0 = LayerNormalization( name="stage4." + str(i) + ".fuse_layers.1.0.0.1")(x1_0)
        x1_1 = x1
        x1_2 = Conv2D(out_filters_list[1], 1, use_bias=False, kernel_initializer='he_normal', name="stage4." + str(i) + ".fuse_layers.1.2.0")(x2)
        x1_2 = LayerNormalization( name="stage4." + str(i) + ".fuse_layers.1.2.1")(x1_2)
        ...
        x1_3 = LayerNormalization( name="stage4." + str(i) + ".fuse_layers.1.3.1")(x1_3)
        ...
        x2_0 = LayerNormalization( name="stage4." + str(i) + ".fuse_layers.2.0.0.1")(x2_0)
        x2_0 = Activation('relu')(x2_0)
        x2_0 = ZeroPadding2D(((1, 1),(1, 1)))(x2_0)
        ...
        x2_0 = LayerNormalization( name="stage4." + str(i) + ".fuse_layers.2.0.1.1")(x2_0)
        x2_1 = ZeroPadding2D(((1, 1),(1, 1)))(x1)
        ...
        x2_1 = LayerNormalization( name="stage4." + str(i) + ".fuse_layers.2.1.0.1")(x2_1)
        x2_2 = x2
        x2_3 = Conv2D(out_filters_list[2], 1, use_bias=False, kernel_initializer='he_normal', name="stage4." + str(i) + ".fuse_layers.2.3.0")(x3)
        x2_3 = LayerNormalization( name="stage4." + str(i) + ".fuse_layers.2.3.1")(x2_3)
        ...
        x3_0 = LayerNormalization( name="stage4." + str(i) + ".fuse_layers.3.0.0.1")(x3_0)
        ...
        x3_0 = LayerNormalization( name="stage4." + str(i) + ".fuse_layers.3.0.1.1")(x3_0)
        x3_0 = Activation('relu')(x3_0)
        x3_0 = ZeroPadding2D(((1, 1),(1, 1)))(x3_0)
        ...
        x3_0 = LayerNormalization( name="stage4." + str(i) + ".fuse_layers.3.0.2.1")(x3_0)
        ...
        x3_1 = LayerNormalization( name="stage4." + str(i) + ".fuse_layers.3.1.0.1")(x3_1)
        ...
        x3_1 = LayerNormalization( name="stage4." + str(i) + ".fuse_layers.3.1.1.1")(x3_1)
        ...
        x3_2 = LayerNormalization( name="stage4." + str(i) + ".fuse_layers.3.2.0.1")(x3_2)
        x3_3 = x3
...
def make_head(x_list, head_channels = [128, 256, 512, 1024]):
    ...
    y = LayerNormalization( name="downsamp_modules.0.1")(y)
    y = Activation('relu')(y)
    ...
    y = LayerNormalization( name="downsamp_modules.1.1")(y)
    y = Activation('relu')(y)
    ...
    y = LayerNormalization( name="downsamp_modules.2.1")(y)
    y = Activation('relu')(y)
    ...
    y = LayerNormalization( name="final_layer.1")(y)
    y = Activation('relu')(y)
    return y
...
def HRnet(input_shape, backbone="hrnetv2_w18"):
    ...
    S4 = Conv2D(256, (1, 1), (1, 1),  padding="valid")(C4)
    S3 = Conv2D(256, (1, 1), (1, 1),  padding="valid")(C3)
    S2 = Conv2D(256, (1, 1), (1, 1),  padding="valid")(C2)
    S1= Conv2D(256, (1, 1), (1, 1),  padding="valid")(C1)

    P4 = S4
    P3 = UpsampleLike()([P4, S3])
    P2 = UpsampleLike()([P3, S2])
    P1 = UpsampleLike()([P2, S1])
    P1 = Conv2D(256, (3, 3), (1, 1),  padding="same")(P1)
   
    model = Model(inputs, P1, name="HRnet")
    return model

...
class ResNest:
    def __init__(self, verbose=False, input_shape=(512, 512, 3), active="relu", n_classes=81,
    ...
    def _make_stem(self, input_tensor, stem_width=64, deep_stem=False):
        ...
        if deep_stem:
            ...
            x = LayerNormalization(axis=self.channel_axis, epsilon=1.001e-5)(x)
    ...
    def _make_block(
        ...
        if stride != 1 or inplanes != filters * self.block_expansion:
            ...
            short_cut = LayerNormalization(axis=self.channel_axis, epsilon=1.001e-5)(short_cut)
        else:
            short_cut = input_tensor
    ...
    def build(self):
        ...
        model = models.Model(inputs=input_sig, outputs=P0)

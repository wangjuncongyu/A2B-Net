...
#define __PYX_HAVE__rotation__rotate_cython_nms
#define __PYX_HAVE_API__rotation__rotate_cython_nms
#include "string.h"
#include "stdio.h"
#include "stdlib.h"
...
/* Module declarations from 'rotation.rotate_cython_nms' */
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_5numpy_float32_t = { "float32_t", NULL, sizeof(__pyx_t_5numpy_float32_t), { 0 }, 0, 'R', 0, 0 };
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_5numpy_int_t = { "int_t", NULL, sizeof(__pyx_t_5numpy_int_t), { 0 }, 0, IS_UNSIGNED(__pyx_t_5numpy_int_t) ? 'U' : 'I', IS_UNSIGNED(__pyx_t_5numpy_int_t), 0 };
#define __Pyx_MODULE_NAME "rotation.rotate_cython_nms"
int __pyx_module_is_main_rotation__rotate_cython_nms = 0;

/* Implementation of 'rotation.rotate_cython_nms' */
...
static char __pyx_k_int_pts[] = "int_pts";
static char __pyx_k_order_pts[] = "order_pts";
static char __pyx_k_ValueError[] = "ValueError";
static char __pyx_k_convexHull[] = "convexHull";
static char __pyx_k_suppressed[] = "suppressed";
static char __pyx_k_contourArea[] = "contourArea";
static char __pyx_k_RuntimeError[] = "RuntimeError";
static char __pyx_k_returnPoints[] = "returnPoints";
static char __pyx_k_rotate_cpu_nms[] = "rotate_cpu_nms";
static char __pyx_k_rotation_rotate_cython_nms[] = "rotation.rotate_cython_nms";
static char __pyx_k_ndarray_is_not_C_contiguous[] = "ndarray is not C contiguous";
static char __pyx_k_rotatedRectangleIntersection[] = "rotatedRectangleIntersection";
static char __pyx_k_home_shiki_alice_workspace_Rota[] = "/home/shiki-alice/workspace/Rotation-Faster-RCNN/py-faster-rcnn/lib/rotation/rotate_cython_nms.pyx";
...
static PyObject *__pyx_n_s_rotation_rotate_cython_nms;
...
static PyObject *__pyx_pf_8rotation_17rotate_cython_nms_rotate_cpu_nms(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_dets, PyObject *__pyx_v_thresh); /* proto */
...
/* "rotation/rotate_cython_nms.pyx":4
 * cimport numpy as np
 * import cv2
...
/* Python wrapper */
static PyObject *__pyx_pw_8rotation_17rotate_cython_nms_1rotate_cpu_nms(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_8rotation_17rotate_cython_nms_1rotate_cpu_nms = {"rotate_cpu_nms", (PyCFunction)__pyx_pw_8rotation_17rotate_cython_nms_1rotate_cpu_nms, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_8rotation_17rotate_cython_nms_1rotate_cpu_nms(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_thresh)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("rotate_cpu_nms", 1, 2, 2, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 4; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "rotate_cpu_nms") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 4; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
  ...
  __Pyx_RaiseArgtupleInvalid("rotate_cpu_nms", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 4; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("rotation.rotate_cython_nms.rotate_cpu_nms", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_dets), __pyx_ptype_5numpy_ndarray, 1, "dets", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 4; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_thresh), (&PyFloat_Type), 1, "thresh", 1))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 4; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_r = __pyx_pf_8rotation_17rotate_cython_nms_rotate_cpu_nms(__pyx_self, __pyx_v_dets, __pyx_v_thresh);
...
static PyObject *__pyx_pf_8rotation_17rotate_cython_nms_rotate_cpu_nms(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_dets, PyObject *__pyx_v_thresh) {
  ...
  __pyx_t_5numpy_float32_t __pyx_t_38;
  double __pyx_t_39;
  ...
  __pyx_pybuffernd_dets.rcbuffer = &__pyx_pybuffer_dets;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_dets.rcbuffer->pybuffer, (PyObject*)__pyx_v_dets, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float32_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 4; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  ...
  /* "rotation/rotate_cython_nms.pyx":5
 * import cv2
 * def rotate_cpu_nms(np.ndarray[np.float32_t, ndim=2] dets, np.float thresh):
 *     cdef np.ndarray[np.float32_t, ndim=1] x_ctrs = dets[:, 0]             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[np.float32_t, ndim=1] y_ctrs = dets[:, 1]
 ...
 */
  __pyx_t_1 = PyObject_GetItem(((PyObject *)__pyx_v_dets), __pyx_tuple__2); if (unlikely(__pyx_t_1 == NULL)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 5; __pyx_clineno = __LINE__; goto __pyx_L1_error;};
  ...
  /* "rotation/rotate_cython_nms.pyx":6
 * def rotate_cpu_nms(np.ndarray[np.float32_t, ndim=2] dets, np.float thresh):
 *     cdef np.ndarray[np.float32_t, ndim=1] x_ctrs = dets[:, 0]
 *     cdef np.ndarray[np.float32_t, ndim=1] y_ctrs = dets[:, 1]             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[np.float32_t, ndim=1] heights = dets[:, 2]
 ...
 */
  __pyx_t_1 = PyObject_GetItem(((PyObject *)__pyx_v_dets), __pyx_tuple__4); if (unlikely(__pyx_t_1 == NULL)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 6; __pyx_clineno = __LINE__; goto __pyx_L1_error;};
  __Pyx_GOTREF(__pyx_t_1);
  ...
  /* "rotation/rotate_cython_nms.pyx":7
 *     cdef np.ndarray[np.float32_t, ndim=1] x_ctrs = dets[:, 0]
 *     cdef np.ndarray[np.float32_t, ndim=1] y_ctrs = dets[:, 1]
 *     cdef np.ndarray[np.float32_t, ndim=1] heights = dets[:, 2]             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[np.float32_t, ndim=1] widths = dets[:, 3]
 ...
 */
  __pyx_t_1 = PyObject_GetItem(((PyObject *)__pyx_v_dets), __pyx_tuple__6); if (unlikely(__pyx_t_1 == NULL)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 7; __pyx_clineno = __LINE__; goto __pyx_L1_error;};
  __Pyx_GOTREF(__pyx_t_1);
  ...
  /* "rotation/rotate_cython_nms.pyx":8
 *     cdef np.ndarray[np.float32_t, ndim=1] y_ctrs = dets[:, 1]
 *     cdef np.ndarray[np.float32_t, ndim=1] heights = dets[:, 2]
 *     cdef np.ndarray[np.float32_t, ndim=1] widths = dets[:, 3]             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[np.float32_t, ndim=1] angles = dets[:, 4]
 ...
 */
  __pyx_t_1 = PyObject_GetItem(((PyObject *)__pyx_v_dets), __pyx_tuple__8); if (unlikely(__pyx_t_1 == NULL)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 8; __pyx_clineno = __LINE__; goto __pyx_L1_error;};
  __Pyx_GOTREF(__pyx_t_1);
  ...
  /* "rotation/rotate_cython_nms.pyx":9
 *     cdef np.ndarray[np.float32_t, ndim=1] heights = dets[:, 2]
 *     cdef np.ndarray[np.float32_t, ndim=1] widths = dets[:, 3]
 *     cdef np.ndarray[np.float32_t, ndim=1] angles = dets[:, 4]             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[np.float32_t, ndim=1] scores = dets[:, 5]
 ...
 */
  __pyx_t_1 = PyObject_GetItem(((PyObject *)__pyx_v_dets), __pyx_tuple__10); if (unlikely(__pyx_t_1 == NULL)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 9; __pyx_clineno = __LINE__; goto __pyx_L1_error;};
  __Pyx_GOTREF(__pyx_t_1);
  ...
  /* "rotation/rotate_cython_nms.pyx":10
 *     cdef np.ndarray[np.float32_t, ndim=1] widths = dets[:, 3]
 *     cdef np.ndarray[np.float32_t, ndim=1] angles = dets[:, 4]
 *     cdef np.ndarray[np.float32_t, ndim=1] scores = dets[:, 5]             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[np.float32_t, ndim=1] areas = heights * widths
 ...
 */
  __pyx_t_1 = PyObject_GetItem(((PyObject *)__pyx_v_dets), __pyx_tuple__12); if (unlikely(__pyx_t_1 == NULL)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L1_error;};
  __Pyx_GOTREF(__pyx_t_1);
  ...
  /* "rotation/rotate_cython_nms.pyx":11
 *     cdef np.ndarray[np.float32_t, ndim=1] angles = dets[:, 4]
 *     cdef np.ndarray[np.float32_t, ndim=1] scores = dets[:, 5]
 *     cdef np.ndarray[np.float32_t, ndim=1] areas = heights * widths             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[np.int_t, ndim=1] order = scores.argsort()[::-1]
 ...
 */
  __pyx_t_1 = PyNumber_Multiply(((PyObject *)__pyx_v_heights), ((PyObject *)__pyx_v_widths)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 11; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  ...
  /* "rotation/rotate_cython_nms.pyx":12
 *     cdef np.ndarray[np.float32_t, ndim=1] scores = dets[:, 5]
 *     cdef np.ndarray[np.float32_t, ndim=1] areas = heights * widths
 *     cdef np.ndarray[np.int_t, ndim=1] order = scores.argsort()[::-1]             # <<<<<<<<<<<<<<
 *     cdef int ndets = dets.shape[0]
 ...
 */
  __pyx_t_9 = __Pyx_PyObject_GetAttrStr(((PyObject *)__pyx_v_scores), __pyx_n_s_argsort); if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  if (__pyx_t_10) {
    __pyx_t_1 = __Pyx_PyObject_CallOneArg(__pyx_t_9, __pyx_t_10); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
  } else {
    __pyx_t_1 = __Pyx_PyObject_CallNoArg(__pyx_t_9); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
  __pyx_t_9 = PyObject_GetItem(__pyx_t_1, __pyx_slice__13); if (unlikely(__pyx_t_9 == NULL)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L1_error;};
  __Pyx_GOTREF(__pyx_t_9);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  if (!(likely(((__pyx_t_9) == Py_None) || likely(__Pyx_TypeTest(__pyx_t_9, __pyx_ptype_5numpy_ndarray))))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  /* "rotation/rotate_cython_nms.pyx":13
 *     cdef np.ndarray[np.float32_t, ndim=1] areas = heights * widths
 *     cdef np.ndarray[np.int_t, ndim=1] order = scores.argsort()[::-1]
 *     cdef int ndets = dets.shape[0]             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[np.int_t, ndim=1] suppressed = np.zeros((ndets), dtype=np.int)
 ...
 */
  ...
  /* "rotation/rotate_cython_nms.pyx":14
 *     cdef np.ndarray[np.int_t, ndim=1] order = scores.argsort()[::-1]
 *     cdef int ndets = dets.shape[0]
 *     cdef np.ndarray[np.int_t, ndim=1] suppressed = np.zeros((ndets), dtype=np.int)             # <<<<<<<<<<<<<<
 *     # nominal indices
 *     cdef int _i, _j
 */
  __pyx_t_9 = __Pyx_GetModuleGlobalName(__pyx_n_s_np); if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_9);
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_t_9, __pyx_n_s_zeros); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
  __pyx_t_9 = __Pyx_PyInt_From_int(__pyx_v_ndets); if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_9);
  ...
  __pyx_t_9 = 0;
  __pyx_t_9 = PyDict_New(); if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_9);
  __pyx_t_12 = __Pyx_GetModuleGlobalName(__pyx_n_s_np); if (unlikely(!__pyx_t_12)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_12);
  __pyx_t_13 = __Pyx_PyObject_GetAttrStr(__pyx_t_12, __pyx_n_s_int); if (unlikely(!__pyx_t_13)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_13);
  __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;
  if (PyDict_SetItem(__pyx_t_9, __pyx_n_s_dtype, __pyx_t_13) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
  __pyx_t_13 = __Pyx_PyObject_Call(__pyx_t_1, __pyx_t_10, __pyx_t_9); if (unlikely(!__pyx_t_13)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_13);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
  __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
  if (!(likely(((__pyx_t_13) == Py_None) || likely(__Pyx_TypeTest(__pyx_t_13, __pyx_ptype_5numpy_ndarray))))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  /* "rotation/rotate_cython_nms.pyx":24
 ...
 *         i = order[_i]
 */
  __pyx_t_13 = PyList_New(0); if (unlikely(!__pyx_t_13)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 24; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_13);
  __pyx_v_keep = ((PyObject*)__pyx_t_13);
  __pyx_t_13 = 0;

  /* "rotation/rotate_cython_nms.pyx":25
 *     cdef np.float32_t inter, ovr
 *     keep = []
 *     for _i in range(ndets):             # <<<<<<<<<<<<<<
 *         i = order[_i]
 ...
 */
  ...
  for (__pyx_t_16 = 0; __pyx_t_16 < __pyx_t_15; __pyx_t_16+=1) {
    ...
    /* "rotation/rotate_cython_nms.pyx":26
 *     keep = []
 *     for _i in range(ndets):
 *         i = order[_i]             # <<<<<<<<<<<<<<
 *         if suppressed[i] == 1:
 ...
 */
    ...
    /* "rotation/rotate_cython_nms.pyx":27
 *     for _i in range(ndets):
 *         i = order[_i]
 *         if suppressed[i] == 1:             # <<<<<<<<<<<<<<
 *             continue
 ...
 */
    ...
    if (__pyx_t_20) {
      ...
      /* "rotation/rotate_cython_nms.pyx":28
 *         i = order[_i]
 *         if suppressed[i] == 1:
 *             continue             # <<<<<<<<<<<<<<
 *         keep.append(i)
 ...
 */
    ...
    /* "rotation/rotate_cython_nms.pyx":29
 *         if suppressed[i] == 1:
 *             continue
 *         keep.append(i)             # <<<<<<<<<<<<<<
 *         ix_ctr = x_ctrs[i]
 *         iy_ctr = y_ctrs[i]
 */
    __pyx_t_13 = __Pyx_PyInt_From_int(__pyx_v_i); if (unlikely(!__pyx_t_13)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 29; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_13);
    __pyx_t_21 = __Pyx_PyList_Append(__pyx_v_keep, __pyx_t_13); if (unlikely(__pyx_t_21 == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 29; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;

    /* "rotation/rotate_cython_nms.pyx":30
 *             continue
 *         keep.append(i)
 *         ix_ctr = x_ctrs[i]             # <<<<<<<<<<<<<<
 *         iy_ctr = y_ctrs[i]
 ...
 */
    ...
    /* "rotation/rotate_cython_nms.pyx":31
 *         keep.append(i)
 *         ix_ctr = x_ctrs[i]
 *         iy_ctr = y_ctrs[i]             # <<<<<<<<<<<<<<
 *         ih = heights[i]
 ...
 */
    ...
    /* "rotation/rotate_cython_nms.pyx":32
 *         ix_ctr = x_ctrs[i]
 *         iy_ctr = y_ctrs[i]
 *         ih = heights[i]             # <<<<<<<<<<<<<<
 *         iw = widths[i]
 ...
 */
    ...
    __pyx_t_18 = -1;
    if (__pyx_t_24 < 0) {
      __pyx_t_24 += __pyx_pybuffernd_heights.diminfo[0].shape;
      if (unlikely(__pyx_t_24 < 0)) __pyx_t_18 = 0;
    } else if (unlikely(__pyx_t_24 >= __pyx_pybuffernd_heights.diminfo[0].shape)) __pyx_t_18 = 0;
    if (unlikely(__pyx_t_18 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_18);
      {__pyx_filename = __pyx_f[0]; __pyx_lineno = 32; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
    __pyx_v_ih = (*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float32_t *, __pyx_pybuffernd_heights.rcbuffer->pybuffer.buf, __pyx_t_24, __pyx_pybuffernd_heights.diminfo[0].strides));

    /* "rotation/rotate_cython_nms.pyx":33
 *         iy_ctr = y_ctrs[i]
 *         ih = heights[i]
 *         iw = widths[i]             # <<<<<<<<<<<<<<
 *         ia = angles[i]
 ...
 */
    ...
    } else if (unlikely(__pyx_t_25 >= __pyx_pybuffernd_widths.diminfo[0].shape)) __pyx_t_18 = 0;
    if (unlikely(__pyx_t_18 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_18);
    ...
    /* "rotation/rotate_cython_nms.pyx":34
 *         ih = heights[i]
 *         iw = widths[i]
 *         ia = angles[i]             # <<<<<<<<<<<<<<
 *         iarea = areas[i]
 ...
 */
    ...
    __pyx_t_18 = -1;
    if (__pyx_t_26 < 0) {
      __pyx_t_26 += __pyx_pybuffernd_angles.diminfo[0].shape;
      if (unlikely(__pyx_t_26 < 0)) __pyx_t_18 = 0;
    } else if (unlikely(__pyx_t_26 >= __pyx_pybuffernd_angles.diminfo[0].shape)) __pyx_t_18 = 0;
    if (unlikely(__pyx_t_18 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_18);
      {__pyx_filename = __pyx_f[0]; __pyx_lineno = 34; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
    __pyx_v_ia = (*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float32_t *, __pyx_pybuffernd_angles.rcbuffer->pybuffer.buf, __pyx_t_26, __pyx_pybuffernd_angles.diminfo[0].strides));

    /* "rotation/rotate_cython_nms.pyx":35
 *         iw = widths[i]
 *         ia = angles[i]
 *         iarea = areas[i]             # <<<<<<<<<<<<<<
 *         r1 = ((ix_ctr, iy_ctr), (ih, iw), ia)
 ...
 */
    ...
    __pyx_t_18 = -1;
    if (__pyx_t_27 < 0) {
      __pyx_t_27 += __pyx_pybuffernd_areas.diminfo[0].shape;
      if (unlikely(__pyx_t_27 < 0)) __pyx_t_18 = 0;
    } else if (unlikely(__pyx_t_27 >= __pyx_pybuffernd_areas.diminfo[0].shape)) __pyx_t_18 = 0;
    if (unlikely(__pyx_t_18 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_18);
      {__pyx_filename = __pyx_f[0]; __pyx_lineno = 35; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
    __pyx_v_iarea = (*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float32_t *, __pyx_pybuffernd_areas.rcbuffer->pybuffer.buf, __pyx_t_27, __pyx_pybuffernd_areas.diminfo[0].strides));

    /* "rotation/rotate_cython_nms.pyx":36
 *         ia = angles[i]
 *         iarea = areas[i]
 *         r1 = ((ix_ctr, iy_ctr), (ih, iw), ia)             # <<<<<<<<<<<<<<
 *         for _j in range(_i+1,ndets):
 *             j = order[_j]
 */
    __pyx_t_13 = PyFloat_FromDouble(__pyx_v_ix_ctr); if (unlikely(!__pyx_t_13)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 36; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_13);
    __pyx_t_9 = PyFloat_FromDouble(__pyx_v_iy_ctr); if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 36; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_9);
    __pyx_t_10 = PyTuple_New(2); if (unlikely(!__pyx_t_10)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 36; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_10);
    ...
    __pyx_t_13 = 0;
    __pyx_t_9 = 0;
    __pyx_t_9 = PyFloat_FromDouble(__pyx_v_ih); if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 36; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_9);
    __pyx_t_13 = PyFloat_FromDouble(__pyx_v_iw); if (unlikely(!__pyx_t_13)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 36; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_13);
    ...
    __pyx_t_9 = 0;
    __pyx_t_13 = 0;
    __pyx_t_13 = PyFloat_FromDouble(__pyx_v_ia); if (unlikely(!__pyx_t_13)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 36; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_13);
    __pyx_t_9 = PyTuple_New(3); if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 36; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_9);
    ...
    /* "rotation/rotate_cython_nms.pyx":37
 *         iarea = areas[i]
 *         r1 = ((ix_ctr, iy_ctr), (ih, iw), ia)
 *         for _j in range(_i+1,ndets):             # <<<<<<<<<<<<<<
 *             j = order[_j]
 ...
 */
    ...
    for (__pyx_t_28 = (__pyx_v__i + 1); __pyx_t_28 < __pyx_t_18; __pyx_t_28+=1) {
      __pyx_v__j = __pyx_t_28;

      /* "rotation/rotate_cython_nms.pyx":38
 *         r1 = ((ix_ctr, iy_ctr), (ih, iw), ia)
 *         for _j in range(_i+1,ndets):
 *             j = order[_j]             # <<<<<<<<<<<<<<
 *             if suppressed[j] == 1:
 ...
 */
      ...
      /* "rotation/rotate_cython_nms.pyx":39
 *         for _j in range(_i+1,ndets):
 *             j = order[_j]
 *             if suppressed[j] == 1:             # <<<<<<<<<<<<<<
 *                 continue
 ...
 */
      ...
      if (__pyx_t_20) {
        ...
        /* "rotation/rotate_cython_nms.pyx":40
 *             j = order[_j]
 *             if suppressed[j] == 1:
 *                 continue             # <<<<<<<<<<<<<<
 *             xx_ctr = x_ctrs[j]
 ...
 */
      ...
      /* "rotation/rotate_cython_nms.pyx":41
 *             if suppressed[j] == 1:
 *                 continue
 *             xx_ctr = x_ctrs[j]             # <<<<<<<<<<<<<<
 *             yy_ctr = y_ctrs[j]
 ...
 */
      ...
      __pyx_t_30 = -1;
      if (__pyx_t_32 < 0) {
        __pyx_t_32 += __pyx_pybuffernd_x_ctrs.diminfo[0].shape;
        if (unlikely(__pyx_t_32 < 0)) __pyx_t_30 = 0;
      } else if (unlikely(__pyx_t_32 >= __pyx_pybuffernd_x_ctrs.diminfo[0].shape)) __pyx_t_30 = 0;
      if (unlikely(__pyx_t_30 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_30);
        {__pyx_filename = __pyx_f[0]; __pyx_lineno = 41; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      }
      __pyx_v_xx_ctr = (*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float32_t *, __pyx_pybuffernd_x_ctrs.rcbuffer->pybuffer.buf, __pyx_t_32, __pyx_pybuffernd_x_ctrs.diminfo[0].strides));

      /* "rotation/rotate_cython_nms.pyx":42
 *                 continue
 *             xx_ctr = x_ctrs[j]
 *             yy_ctr = y_ctrs[j]             # <<<<<<<<<<<<<<
 *             hh = heights[j]
 ...
 */
      ...
      __pyx_t_30 = -1;
      if (__pyx_t_33 < 0) {
        __pyx_t_33 += __pyx_pybuffernd_y_ctrs.diminfo[0].shape;
        if (unlikely(__pyx_t_33 < 0)) __pyx_t_30 = 0;
      } else if (unlikely(__pyx_t_33 >= __pyx_pybuffernd_y_ctrs.diminfo[0].shape)) __pyx_t_30 = 0;
      if (unlikely(__pyx_t_30 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_30);
        {__pyx_filename = __pyx_f[0]; __pyx_lineno = 42; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      }
      __pyx_v_yy_ctr = (*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float32_t *, __pyx_pybuffernd_y_ctrs.rcbuffer->pybuffer.buf, __pyx_t_33, __pyx_pybuffernd_y_ctrs.diminfo[0].strides));

      /* "rotation/rotate_cython_nms.pyx":43
 *             xx_ctr = x_ctrs[j]
 *             yy_ctr = y_ctrs[j]
 *             hh = heights[j]             # <<<<<<<<<<<<<<
 *             ww = widths[j]
 ...
 */
      ...
      __pyx_t_30 = -1;
      if (__pyx_t_34 < 0) {
        __pyx_t_34 += __pyx_pybuffernd_heights.diminfo[0].shape;
        if (unlikely(__pyx_t_34 < 0)) __pyx_t_30 = 0;
      } else if (unlikely(__pyx_t_34 >= __pyx_pybuffernd_heights.diminfo[0].shape)) __pyx_t_30 = 0;
      if (unlikely(__pyx_t_30 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_30);
        {__pyx_filename = __pyx_f[0]; __pyx_lineno = 43; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      }
      __pyx_v_hh = (*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float32_t *, __pyx_pybuffernd_heights.rcbuffer->pybuffer.buf, __pyx_t_34, __pyx_pybuffernd_heights.diminfo[0].strides));

      /* "rotation/rotate_cython_nms.pyx":44
 *             yy_ctr = y_ctrs[j]
 *             hh = heights[j]
 *             ww = widths[j]             # <<<<<<<<<<<<<<
 *             aa = angles[j]
 ...
 */
      ...
      __pyx_t_30 = -1;
      if (__pyx_t_35 < 0) {
        __pyx_t_35 += __pyx_pybuffernd_widths.diminfo[0].shape;
        if (unlikely(__pyx_t_35 < 0)) __pyx_t_30 = 0;
      } else if (unlikely(__pyx_t_35 >= __pyx_pybuffernd_widths.diminfo[0].shape)) __pyx_t_30 = 0;
      if (unlikely(__pyx_t_30 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_30);
        {__pyx_filename = __pyx_f[0]; __pyx_lineno = 44; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      }
      __pyx_v_ww = (*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float32_t *, __pyx_pybuffernd_widths.rcbuffer->pybuffer.buf, __pyx_t_35, __pyx_pybuffernd_widths.diminfo[0].strides));

      /* "rotation/rotate_cython_nms.pyx":45
 *             hh = heights[j]
 *             ww = widths[j]
 *             aa = angles[j]             # <<<<<<<<<<<<<<
 *             r2 = ((xx_ctr,yy_ctr),(ww,hh),aa)
 ...
 */
      ...
      __pyx_t_30 = -1;
      if (__pyx_t_36 < 0) {
        __pyx_t_36 += __pyx_pybuffernd_angles.diminfo[0].shape;
        if (unlikely(__pyx_t_36 < 0)) __pyx_t_30 = 0;
      } else if (unlikely(__pyx_t_36 >= __pyx_pybuffernd_angles.diminfo[0].shape)) __pyx_t_30 = 0;
      if (unlikely(__pyx_t_30 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_30);
        {__pyx_filename = __pyx_f[0]; __pyx_lineno = 45; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      }
      __pyx_v_aa = (*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float32_t *, __pyx_pybuffernd_angles.rcbuffer->pybuffer.buf, __pyx_t_36, __pyx_pybuffernd_angles.diminfo[0].strides));

      /* "rotation/rotate_cython_nms.pyx":46
 *             ww = widths[j]
 *             aa = angles[j]
 *             r2 = ((xx_ctr,yy_ctr),(ww,hh),aa)             # <<<<<<<<<<<<<<
 *             ovr = 0.0
 ...
 */
      __pyx_t_9 = PyFloat_FromDouble(__pyx_v_xx_ctr); if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 46; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_9);
      __pyx_t_13 = PyFloat_FromDouble(__pyx_v_yy_ctr); if (unlikely(!__pyx_t_13)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 46; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_13);
      ...
      __pyx_t_9 = 0;
      __pyx_t_13 = 0;
      __pyx_t_13 = PyFloat_FromDouble(__pyx_v_ww); if (unlikely(!__pyx_t_13)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 46; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_13);
      __pyx_t_9 = PyFloat_FromDouble(__pyx_v_hh); if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 46; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_9);
      ...
      __pyx_t_13 = 0;
      __pyx_t_9 = 0;
      __pyx_t_9 = PyFloat_FromDouble(__pyx_v_aa); if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 46; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_9);
      __pyx_t_13 = PyTuple_New(3); if (unlikely(!__pyx_t_13)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 46; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_13);
      __Pyx_GIVEREF(__pyx_t_1);
      ...
      /* "rotation/rotate_cython_nms.pyx":47
 *             aa = angles[j]
 *             r2 = ((xx_ctr,yy_ctr),(ww,hh),aa)
 *             ovr = 0.0             # <<<<<<<<<<<<<<
 *             int_pts = cv2.rotatedRectangleIntersection(r1, r2)[1]
 ...
 */
      ...
      /* "rotation/rotate_cython_nms.pyx":48
 *             r2 = ((xx_ctr,yy_ctr),(ww,hh),aa)
 *             ovr = 0.0
 *             int_pts = cv2.rotatedRectangleIntersection(r1, r2)[1]             # <<<<<<<<<<<<<<
 *             if  None != int_pts:
 ...
 */
      __pyx_t_9 = __Pyx_GetModuleGlobalName(__pyx_n_s_cv2); if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 48; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_9);
      __pyx_t_10 = __Pyx_PyObject_GetAttrStr(__pyx_t_9, __pyx_n_s_rotatedRectangleIntersection); if (unlikely(!__pyx_t_10)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 48; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_10);
      __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
      __pyx_t_9 = NULL;
      __pyx_t_37 = 0;
      ...
      __pyx_t_1 = PyTuple_New(2+__pyx_t_37); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 48; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_1);
      if (__pyx_t_9) {
      ...
      PyTuple_SET_ITEM(__pyx_t_1, 0+__pyx_t_37, __pyx_v_r1);
      __Pyx_INCREF(__pyx_v_r2);
      __Pyx_GIVEREF(__pyx_v_r2);
      PyTuple_SET_ITEM(__pyx_t_1, 1+__pyx_t_37, __pyx_v_r2);
      __pyx_t_13 = __Pyx_PyObject_Call(__pyx_t_10, __pyx_t_1, NULL); if (unlikely(!__pyx_t_13)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 48; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_13);
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
      __pyx_t_10 = __Pyx_GetItemInt(__pyx_t_13, 1, long, 1, __Pyx_PyInt_From_long, 0, 0, 1); if (unlikely(__pyx_t_10 == NULL)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 48; __pyx_clineno = __LINE__; goto __pyx_L1_error;};
      __Pyx_GOTREF(__pyx_t_10);
      __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
      __Pyx_XDECREF_SET(__pyx_v_int_pts, __pyx_t_10);
      __pyx_t_10 = 0;

      /* "rotation/rotate_cython_nms.pyx":49
 *             ovr = 0.0
 *             int_pts = cv2.rotatedRectangleIntersection(r1, r2)[1]
 *             if  None != int_pts:             # <<<<<<<<<<<<<<
 *                 order_pts = cv2.convexHull(int_pts, returnPoints = True)
 ...
 */
      __pyx_t_10 = PyObject_RichCompare(Py_None, __pyx_v_int_pts, Py_NE); __Pyx_XGOTREF(__pyx_t_10); if (unlikely(!__pyx_t_10)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 49; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __pyx_t_20 = __Pyx_PyObject_IsTrue(__pyx_t_10); if (unlikely(__pyx_t_20 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 49; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
      if (__pyx_t_20) {

        /* "rotation/rotate_cython_nms.pyx":50
 *             int_pts = cv2.rotatedRectangleIntersection(r1, r2)[1]
 *             if  None != int_pts:
 *                 order_pts = cv2.convexHull(int_pts, returnPoints = True)             # <<<<<<<<<<<<<<
 *                 inter = cv2.contourArea(order_pts)
 *                 ovr = inter*1.0 / (iarea+areas[j]-inter)
 */
        __pyx_t_10 = __Pyx_GetModuleGlobalName(__pyx_n_s_cv2); if (unlikely(!__pyx_t_10)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 50; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_10);
        __pyx_t_13 = __Pyx_PyObject_GetAttrStr(__pyx_t_10, __pyx_n_s_convexHull); if (unlikely(!__pyx_t_13)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 50; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_13);
        __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
        ...
        __Pyx_GOTREF(__pyx_t_1);
        if (PyDict_SetItem(__pyx_t_1, __pyx_n_s_returnPoints, Py_True) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 50; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __pyx_t_9 = __Pyx_PyObject_Call(__pyx_t_13, __pyx_t_10, __pyx_t_1); if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 50; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_9);
        __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
        __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
        __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
        ...
        /* "rotation/rotate_cython_nms.pyx":51
 *             if  None != int_pts:
 *                 order_pts = cv2.convexHull(int_pts, returnPoints = True)
 *                 inter = cv2.contourArea(order_pts)             # <<<<<<<<<<<<<<
 *                 ovr = inter*1.0 / (iarea+areas[j]-inter)
 *             if ovr>=thresh:
 */
        __pyx_t_1 = __Pyx_GetModuleGlobalName(__pyx_n_s_cv2); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 51; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_1);
        __pyx_t_10 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_contourArea); if (unlikely(!__pyx_t_10)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 51; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_10);
        __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
        __pyx_t_1 = NULL;
        if (CYTHON_COMPILING_IN_CPYTHON && unlikely(PyMethod_Check(__pyx_t_10))) {
        ...
        if (!__pyx_t_1) {
          __pyx_t_9 = __Pyx_PyObject_CallOneArg(__pyx_t_10, __pyx_v_order_pts); if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 51; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
          __Pyx_GOTREF(__pyx_t_9);
        } else {
          ...
          __Pyx_INCREF(__pyx_v_order_pts);
          __Pyx_GIVEREF(__pyx_v_order_pts);
          PyTuple_SET_ITEM(__pyx_t_13, 0+1, __pyx_v_order_pts);
          __pyx_t_9 = __Pyx_PyObject_Call(__pyx_t_10, __pyx_t_13, NULL); if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 51; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
          __Pyx_GOTREF(__pyx_t_9);
          __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
        }
        __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
        __pyx_t_38 = __pyx_PyFloat_AsFloat(__pyx_t_9); if (unlikely((__pyx_t_38 == (npy_float32)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 51; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
        __pyx_v_inter = __pyx_t_38;

        /* "rotation/rotate_cython_nms.pyx":52
 *                 order_pts = cv2.convexHull(int_pts, returnPoints = True)
 *                 inter = cv2.contourArea(order_pts)
 *                 ovr = inter*1.0 / (iarea+areas[j]-inter)             # <<<<<<<<<<<<<<
 *             if ovr>=thresh:
 *                 suppressed[j]=1
 */
        __pyx_t_39 = (__pyx_v_inter * 1.0);
        __pyx_t_40 = __pyx_v_j;
        __pyx_t_30 = -1;
        if (__pyx_t_40 < 0) {
          __pyx_t_40 += __pyx_pybuffernd_areas.diminfo[0].shape;
          if (unlikely(__pyx_t_40 < 0)) __pyx_t_30 = 0;
        } else if (unlikely(__pyx_t_40 >= __pyx_pybuffernd_areas.diminfo[0].shape)) __pyx_t_30 = 0;
        if (unlikely(__pyx_t_30 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_30);
          {__pyx_filename = __pyx_f[0]; __pyx_lineno = 52; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        }
        __pyx_t_38 = ((__pyx_v_iarea + (*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float32_t *, __pyx_pybuffernd_areas.rcbuffer->pybuffer.buf, __pyx_t_40, __pyx_pybuffernd_areas.diminfo[0].strides))) - __pyx_v_inter);
        if (unlikely(__pyx_t_38 == 0)) {
          PyErr_SetString(PyExc_ZeroDivisionError, "float division");
          {__pyx_filename = __pyx_f[0]; __pyx_lineno = 52; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        }
        __pyx_v_ovr = (__pyx_t_39 / __pyx_t_38);
 ...
 */
      ...
      /* "rotation/rotate_cython_nms.pyx":53
 *                 inter = cv2.contourArea(order_pts)
 *                 ovr = inter*1.0 / (iarea+areas[j]-inter)
 *             if ovr>=thresh:             # <<<<<<<<<<<<<<
 *                 suppressed[j]=1
 *     return keep
 */
      __pyx_t_9 = PyFloat_FromDouble(__pyx_v_ovr); if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 53; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_9);
      __pyx_t_10 = PyObject_RichCompare(__pyx_t_9, __pyx_v_thresh, Py_GE); __Pyx_XGOTREF(__pyx_t_10); if (unlikely(!__pyx_t_10)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 53; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
      __pyx_t_20 = __Pyx_PyObject_IsTrue(__pyx_t_10); if (unlikely(__pyx_t_20 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 53; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
      if (__pyx_t_20) {

        /* "rotation/rotate_cython_nms.pyx":54
 *                 ovr = inter*1.0 / (iarea+areas[j]-inter)
 *             if ovr>=thresh:
 *                 suppressed[j]=1             # <<<<<<<<<<<<<<
 *     return keep
 */
        ...
        __pyx_t_30 = -1;
        if (__pyx_t_41 < 0) {
          __pyx_t_41 += __pyx_pybuffernd_suppressed.diminfo[0].shape;
          if (unlikely(__pyx_t_41 < 0)) __pyx_t_30 = 0;
        } else if (unlikely(__pyx_t_41 >= __pyx_pybuffernd_suppressed.diminfo[0].shape)) __pyx_t_30 = 0;
        if (unlikely(__pyx_t_30 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_30);
 ...
 */
  ...
  /* "rotation/rotate_cython_nms.pyx":55
 *             if ovr>=thresh:
 *                 suppressed[j]=1
 *     return keep             # <<<<<<<<<<<<<<
 */
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_rotation_rotate_cython_nms, __pyx_k_rotation_rotate_cython_nms, sizeof(__pyx_k_rotation_rotate_cython_nms), 0, 0, 1, 1},
 ...
 *     cdef np.ndarray[np.float32_t, ndim=1] heights = dets[:, 2]
 */
  __pyx_slice_ = PySlice_New(Py_None, Py_None, Py_None); if (unlikely(!__pyx_slice_)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 5; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_slice_);
  __Pyx_GIVEREF(__pyx_slice_);
  __pyx_tuple__2 = PyTuple_Pack(2, __pyx_slice_, __pyx_int_0); if (unlikely(!__pyx_tuple__2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 5; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *     cdef np.ndarray[np.float32_t, ndim=1] widths = dets[:, 3]
 */
  __pyx_slice__3 = PySlice_New(Py_None, Py_None, Py_None); if (unlikely(!__pyx_slice__3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 6; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_slice__3);
  __Pyx_GIVEREF(__pyx_slice__3);
  __pyx_tuple__4 = PyTuple_Pack(2, __pyx_slice__3, __pyx_int_1); if (unlikely(!__pyx_tuple__4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 6; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *     cdef np.ndarray[np.float32_t, ndim=1] angles = dets[:, 4]
 */
  __pyx_slice__5 = PySlice_New(Py_None, Py_None, Py_None); if (unlikely(!__pyx_slice__5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 7; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_slice__5);
  __Pyx_GIVEREF(__pyx_slice__5);
  __pyx_tuple__6 = PyTuple_Pack(2, __pyx_slice__5, __pyx_int_2); if (unlikely(!__pyx_tuple__6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 7; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *     cdef np.ndarray[np.float32_t, ndim=1] scores = dets[:, 5]
 */
  __pyx_slice__7 = PySlice_New(Py_None, Py_None, Py_None); if (unlikely(!__pyx_slice__7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 8; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_slice__7);
  __Pyx_GIVEREF(__pyx_slice__7);
  __pyx_tuple__8 = PyTuple_Pack(2, __pyx_slice__7, __pyx_int_3); if (unlikely(!__pyx_tuple__8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 8; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *     cdef np.ndarray[np.float32_t, ndim=1] areas = heights * widths
 */
  __pyx_slice__9 = PySlice_New(Py_None, Py_None, Py_None); if (unlikely(!__pyx_slice__9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 9; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_slice__9);
  __Pyx_GIVEREF(__pyx_slice__9);
  __pyx_tuple__10 = PyTuple_Pack(2, __pyx_slice__9, __pyx_int_4); if (unlikely(!__pyx_tuple__10)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 9; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *     cdef np.ndarray[np.int_t, ndim=1] order = scores.argsort()[::-1]
 */
  __pyx_slice__11 = PySlice_New(Py_None, Py_None, Py_None); if (unlikely(!__pyx_slice__11)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_slice__11);
  __Pyx_GIVEREF(__pyx_slice__11);
  __pyx_tuple__12 = PyTuple_Pack(2, __pyx_slice__11, __pyx_int_5); if (unlikely(!__pyx_tuple__12)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *     cdef np.ndarray[np.int_t, ndim=1] suppressed = np.zeros((ndets), dtype=np.int)
 */
  __pyx_slice__13 = PySlice_New(Py_None, Py_None, __pyx_int_neg_1); if (unlikely(!__pyx_slice__13)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *     cdef np.ndarray[np.float32_t, ndim=1] y_ctrs = dets[:, 1]
 */
  __pyx_tuple__20 = PyTuple_Pack(34, __pyx_n_s_dets, __pyx_n_s_thresh, __pyx_n_s_x_ctrs, __pyx_n_s_y_ctrs, __pyx_n_s_heights, __pyx_n_s_widths, __pyx_n_s_angles, __pyx_n_s_scores, __pyx_n_s_areas, __pyx_n_s_order, __pyx_n_s_ndets, __pyx_n_s_suppressed, __pyx_n_s_i_2, __pyx_n_s_j, __pyx_n_s_i, __pyx_n_s_j_2, __pyx_n_s_ix_ctr, __pyx_n_s_iy_ctr, __pyx_n_s_ih, __pyx_n_s_iw, __pyx_n_s_ia, __pyx_n_s_iarea, __pyx_n_s_xx_ctr, __pyx_n_s_yy_ctr, __pyx_n_s_hh, __pyx_n_s_ww, __pyx_n_s_aa, __pyx_n_s_inter, __pyx_n_s_ovr, __pyx_n_s_keep, __pyx_n_s_r1, __pyx_n_s_r2, __pyx_n_s_int_pts, __pyx_n_s_order_pts); if (unlikely(!__pyx_tuple__20)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 4; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_tuple__20);
  __Pyx_GIVEREF(__pyx_tuple__20);
  __pyx_codeobj__21 = (PyObject*)__Pyx_PyCode_New(2, 0, 34, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__20, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_home_shiki_alice_workspace_Rota, __pyx_n_s_rotate_cpu_nms, 4, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__21)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 4; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initrotate_cython_nms(void); /*proto*/
PyMODINIT_FUNC initrotate_cython_nms(void)
#else
PyMODINIT_FUNC PyInit_rotate_cython_nms(void); /*proto*/
PyMODINIT_FUNC PyInit_rotate_cython_nms(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_rotate_cython_nms(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("rotate_cython_nms", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_rotation__rotate_cython_nms) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    if (!PyDict_GetItemString(modules, "rotation.rotate_cython_nms")) {
      if (unlikely(PyDict_SetItemString(modules, "rotation.rotate_cython_nms", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "rotation/rotate_cython_nms.pyx":1
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport numpy as np
 * import cv2
 */
  ...
  /* "rotation/rotate_cython_nms.pyx":3
 * import numpy as np
 * cimport numpy as np
 * import cv2             # <<<<<<<<<<<<<<
 * def rotate_cpu_nms(np.ndarray[np.float32_t, ndim=2] dets, np.float thresh):
 ...
 *     cdef np.ndarray[np.float32_t, ndim=1] y_ctrs = dets[:, 1]
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_8rotation_17rotate_cython_nms_1rotate_cpu_nms, NULL, __pyx_n_s_rotation_rotate_cython_nms); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 4; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_rotate_cpu_nms, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 4; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init rotation.rotate_cython_nms", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init rotation.rotate_cython_nms");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
